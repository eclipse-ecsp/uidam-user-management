...
| Feature                             | Curl                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           
|:------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Create Scope /v1/scopes             | ```curl -X POST "http://localhost:8080/v1/scopes" -H "accept: application/json" -H "scope: ManageUserRolesAndPermissions"  -H "content-type: application/json" -H "user-id: <USER_ID>" -d '{"name":<SCOPE_NAME>,"description":"This scope will allow user to manage all users.","administrative":false}'```                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| Update Scope /v1/scopes             | ```curl -X PATCH "http://localhost:8080/v1/scopes/<scopeName>" -H "accept: application/json" -H "scope: ManageUserRolesAndPermissions" -H "content-type: application/json" -H "user-id: <USER_ID>" -d '{"description":"Updated description","administrative":false}'```                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Delete Scope /v1/scopes             | ```curl -X DELETE "http://localhost:8080/v1/scopes/<scopeName>" -H "accept: application/json" -H "scope: ManageUserRolesAndPermissions" -H "user-id: <USER_ID>"```                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| Create Role /v1/roles               | ```curl -X POST "http://localhost:8080/v1/roles" -H "accept: application/json" -H "scope: ManageUserRolesAndPermissions" -H "content-type: application/json" -H "user_id: <USER_ID>" -d '{"name":<ROLE_NAME>,"description":<ROLE_DESCRIPTION>,"scopeNames":[<COMMA_SEP_LIST_OF_SCOPES>]}'```                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| Update Role /v1/roles/{role}        | ```curl -X PATCH "http://localhost:8080/v1/roles/{roleName}" -H "accept: application/json" -H "scope: ManageUserRolesAndPermissions" -H "content-type: application/json" -H "user_id: <USER_ID>" -d '{"description":"new updated description","scopeNames":[<COMMA_SEP_LIST_OF_SCOPES>]}'```                                                                                                                                                                                                                                                                                                                                                                                                                                          |
