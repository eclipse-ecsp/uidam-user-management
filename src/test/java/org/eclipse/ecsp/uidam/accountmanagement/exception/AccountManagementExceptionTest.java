...
class AccountManagementExceptionTest {
    ...
    void testConstructorWithKeyAndHttpStatusAndValues() {
        ...
        AccountManagementException exception = new AccountManagementException(
                AccountApiConstants.ACCOUNT_ALREADY_EXISTS, message, Arrays.asList(property), httpStatus);

        assertEquals(AccountApiConstants.ACCOUNT_ALREADY_EXISTS, exception.getCode());
