...
/**
 * recover secret entity.
 *
 */
@Entity
@Table(name = "user_recovery_secret_details")
@Getter
@Setter
@ToString
public class UserRecoverySecret {
    @Id
    ...
    private String recoverySecretStatus;

    @Column(name = "SECRET_GENERATED_AT")
    private Instant secretGeneratedAt;

    @PrePersist
    private void prePersist() {
        secretGeneratedAt = Instant.now();
        recoverySecretStatus = UserRecoverySecretStatus.GENERATED.name();
    }
