 ...
 */
@Getter
public class UserAccountRoleMappingException extends Exception {

    private static final long serialVersionUID = -3339365169800826971L;
    @Getter
     ...
     */
    public UserAccountRoleMappingException(String code, String message, List<ErrorProperty> property,
