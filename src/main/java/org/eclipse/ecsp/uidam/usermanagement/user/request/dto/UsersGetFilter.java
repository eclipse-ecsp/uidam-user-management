...
public class UsersGetFilter {
    ...
    @Valid
    private Set<@NotNull(message = INVALID_NULL_ELEMENT) UUID> ids;
    ...
    private Set<@NotNull(message = INVALID_NULL_ELEMENT) Gender> gender;
    ...
    @Size(min = MIN_LENGTH, max = MAX_PER_SET, message = INVALID_LENGTH)
    @Valid
    private Set<@NotNull(message = INVALID_NULL_ELEMENT) UserStatus> status;
