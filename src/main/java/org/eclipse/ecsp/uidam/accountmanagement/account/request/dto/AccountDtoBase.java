...
/**
 * Represents an account data transfer object. This class contains information
 * such as parent ID, roles.
 */
@Getter
@Setter
@NoArgsConstructor
public class AccountDtoBase {
    ...
    @Schema(description = AccountApiConstants.FieldComments.PARENT_ID, example = "1")
    protected String parentId;

    @Schema(description = ROLE_FIELD_DESCRIPTION, example = "[\"TENANT_ADMIN\"]")
