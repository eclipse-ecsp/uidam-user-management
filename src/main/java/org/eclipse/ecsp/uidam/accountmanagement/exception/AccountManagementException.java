 ...
 */
public class AccountManagementException extends RuntimeException implements Serializable {

    private static final long serialVersionUID = -4449365169800826971L;
    @Getter
     ...
     */
    public AccountManagementException(String code, String message, List<ErrorProperty> property,
