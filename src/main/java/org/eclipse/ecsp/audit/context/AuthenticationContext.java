...
/**
 * Authentication Context - Contains authentication method details (password, IDP, MFA, etc.).
...
public interface AuthenticationContext {
    ...
    /**
     * Get authentication context as a map for JSON serialization.
     * PII fields in this map will be automatically masked.
     *
     * @return map of authentication context data
     */
