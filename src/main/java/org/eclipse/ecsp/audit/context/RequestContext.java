...
/**
 * Request Context - Contains HTTP request information (IP, user agent, session, etc.).
...
public interface RequestContext {
    ...
    /**
     * Get request context as a map for JSON serialization.
     * PII fields in this map will be automatically masked.
     *
     * @return map of request context data
     */
